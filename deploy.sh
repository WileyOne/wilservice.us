...
# Fully containerized: https://github.com/WileyOne/wilservice.us — image ghcr.io/wileyone/wilservice.us:latest (see PUBLISH-IMAGE.md). Hostname test.wilservice.us — TrueNas setup docs/deploy-wilservice-step-by-step.md
